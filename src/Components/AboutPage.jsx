  ...
  return (
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-white w-full sm:py-10 py-8  ">
        ...
        URLytics is a smart link management platform that empowers businesses to optimize their digital reach through efficient URL shortening and real-time analytics. Designed with performance and precision in mind, URLytics helps brands streamline link sharing, track engagement, and make data-driven decisions.
        With a clean interface and powerful tracking tools, URLytics enables marketing teams, content strategists, and growth professionals to monitor link performance, understand audience behavior, and maximize ROI on every shared URL. Whether you're launching a campaign or scaling your digital presence, URLytics is built to grow with your goals.
        </p>
