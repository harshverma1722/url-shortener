    ...
    <div className="min-h-[calc(100vh-64px)]  lg:px-14 sm:px-8 px-4">
      <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
        <div className=" flex-1">
          ...
          >
           URLytics helps you shorten links and track real-time analytics to boost your link performance.
          </motion.h1>
          <p className="text-slate-700 text-sm my-5">
          URLytics streamlines the process of URL shortening, making link sharing effortless and efficient. With its user-friendly interface, URLytics lets you generate concise, trackable URLs in seconds—while providing powerful insights through real-time analytics. Simplify and optimize your link-sharing experience with URLytics today.
          </p>
